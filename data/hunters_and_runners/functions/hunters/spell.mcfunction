...
execute if entity @s[team=hunters] run tellraw @s [{"text":"[Glowing]","color":"yellow","clickEvent":{"action":"run_command","value":"/trigger hnr.spell.cast set 7"},"hoverEvent":{"action":"show_text","value":{"text":"Makes all players glowo for 30s"}}},{"text":"                     ","hoverEvent":{"action":"show_text","contents":[{"text":""}]},"clickEvent":{"action":"run_command","value":""}},{"text":"[Paralysis]","color":"gold","clickEvent":{"action":"run_command","value":"/trigger hnr.spell.cast set 8"},"hoverEvent":{"action":"show_text","value":{"text":"Makes players unable to move for 10s"}}}]
