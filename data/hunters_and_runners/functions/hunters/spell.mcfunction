...
execute if entity @s[team=hunters] run tellraw @s [{"text":"[Blindness]","color":"gray","clickEvent":{"action":"run_command","value":"/trigger hnr.spell.cast set 4"},"hoverEvent":{"action":"show_text","value":{"text":"Blinds Runners and Spectators for 30s"}}},{"text":"                  "},{"text":"[Hunter's Axe]","color":"green","clickEvent":{"action":"run_command","value":"/trigger hnr.spell.cast set 5"},"hoverEvent":{"action":"show_text","value":{"text":"Gives you an OP axe with low durability"}}}]
...
execute if entity @s[team=hunters] run tellraw @s [{"text":"[Glowing]","color":"yellow","clickEvent":{"action":"run_command","value":"/trigger hnr.spell.cast set 7"},"hoverEvent":{"action":"show_text","value":{"text":"Makes all players glowo for 30s"}}},{"text":"                      "},{"text":"[Paralysis]","color":"gold","clickEvent":{"action":"run_command","value":"/trigger hnr.spell.cast set 8"},"hoverEvent":{"action":"show_text","value":{"text":"Makes players unable to move for 10s"}}}]
...
execute if entity @s[team=hunters] run tellraw @s [{"text":"[Mining Fatigue]","color":"gold","clickEvent":{"action":"run_command","value":"/trigger hnr.spell.cast set 10"},"hoverEvent":{"action":"show_text","value":{"text":"Makes all runners mine slower - just like an Elder Guardian!"}}},{"text":"                "},{"text":"[Nausea]","color":"yellow","clickEvent":{"action":"run_command","value":"/trigger hnr.spell.cast set 11"},"hoverEvent":{"action":"show_text","value":{"text":"Makes all players feel nauseous for 30s"}}}]
execute if entity @s[team=hunters] run tellraw @s [{"text":"                       "},{"text":"[Haste]","color":"yellow","clickEvent":{"action":"run_command","value":"/trigger hnr.spell.cast set 12"},"hoverEvent":{"action":"show_text","value":{"text":"All hunters break blocks faster for 30s"}}}]
...
#> Show Spell Footer
execute if entity @s[team=hunters] run tellraw @s [{"text":"===========================","color":"gold"}]
