...
#> Cast spell
execute if score @s hnr.spell.cool matches 0 run give @s netherite_axe{display:{Name:"\"Hunter's Axe\"",Lore:["\"Sufficient to kill 1 player\""]},Enchantments:[{id:"minecraft:vanishing_curse",lvl:1}],Damage:2030} 1
