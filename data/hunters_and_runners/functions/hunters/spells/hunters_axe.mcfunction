...
#> Cast spell
execute if score @s hnr.spell.cool matches 0 run execute if score @s hnr.spell.count matches 3.. run give @s netherite_axe{display:{Name:"\"Hunter's Axe\"",Lore:["\"Sufficient to kill 1 player\""]},Enchantments:[{id:"minecraft:sharpness",lvl:3s},{id:"minecraft:vanishing_curse",lvl:1s}],Damage:2028,RepairCost:500} 1
