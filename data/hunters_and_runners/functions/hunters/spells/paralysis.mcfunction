...
#> Cast spell
execute if score @s hnr.spell.cool matches 0 run effect give @a[team=runners] minecraft:slowness 15 255 true
execute if score @s hnr.spell.cool matches 0 run effect give @a[team=runners] minecraft:jump_boost 15 137 true
