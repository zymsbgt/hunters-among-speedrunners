...
execute unless entity @a[tag=tracking] if entity @s[nbt={Dimension:"minecraft:overworld"}] run tag @a[team=!hunters,limit=1,sort=nearest,nbt={Dimension:"minecraft:overworld"}] add tracking
execute unless entity @a[tag=tracking] if entity @s[nbt={Dimension:"minecraft:the_end"}] run tag @a[team=!hunters,limit=1,sort=nearest,nbt={Dimension:"minecraft:the_end"}] add tracking
execute unless entity @a[tag=tracking] if entity @s[nbt={Dimension:"minecraft:the_nether"}] run tag @a[team=!hunters,limit=1,sort=nearest,nbt={Dimension:"minecraft:the_nether"}] add tracking
