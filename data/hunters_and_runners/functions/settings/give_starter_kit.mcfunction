#> Toggle our setting
execute if score give_starter_kit hnr.settings matches 2 run scoreboard players set give_starter_kit hnr.settings 3
...
execute if score give_starter_kit hnr.settings matches 3 run scoreboard players set give_starter_kit hnr.settings 0
