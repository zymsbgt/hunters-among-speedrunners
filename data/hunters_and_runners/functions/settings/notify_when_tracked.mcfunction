#> Toggle our setting
execute if score notify_when_tracked hnr.settings matches 2 run scoreboard players set notify_when_tracked hnr.settings 3
...
execute if score notify_when_tracked hnr.settings matches 3 run scoreboard players set notify_when_tracked hnr.settings 0
