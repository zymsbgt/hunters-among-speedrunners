...
execute if score give_starter_kit hnr.settings matches 1 run execute if entity @s[scores={hnr.eligiblekit=1..}] run function hunters_and_runners:starterkit/player_claim_kit
execute if score give_starter_kit hnr.settings matches 2 run execute if score nether_loaded hnr.settings matches 1 run execute if entity @s[scores={hnr.eligiblekit=1..}] run function hunters_and_runners:starterkit/player_claim_kit
